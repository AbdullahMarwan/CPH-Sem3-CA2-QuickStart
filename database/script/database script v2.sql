...
CREATE TABLE `facts` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_facts_users1_idx` (`user_name`),
...
CREATE TABLE `quotes` (
  `id` int NOT NULL AUTO_INCREMENT,
  `quote` varchar(225) NOT NULL,
  `user_name` varchar(25) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_quotes_users1_idx` (`user_name`),
  CONSTRAINT `fk_quotes_users1` FOREIGN KEY (`user_name`) REFERENCES `users` (`user_name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping events for database 'ca2'
--

--
-- Dumping routines for database 'ca2'
--
...
-- Dump completed on 2023-04-26 11:06:56
